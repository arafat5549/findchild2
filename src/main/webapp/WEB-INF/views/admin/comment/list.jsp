                        ...
                        <div class="modal-content animated bounceInRight">
                           ...
                           <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form-horizontal" role="form" id="modalForm" method="post" action="${context }/admin/comment">
...
<div id="wrapper">    
	...
	<c:if test="${not empty sessionScope.session_user }">
		<%@ include file="/Public/include/back/comment/listPage.jsp" %>
	</c:if>
    ...
    var admin_table =  $("#admin_table").DataTable({
		  ...
		  */
          ...
          //"serverSide": true,  //服务端#分页 
           ajax: {
        	     //Ajax数据库请求
                 url: '${context}/admin/comment?method=ajaxquery&xid=${param.xid}',
          ...
          "columns": [
                    ...
                    { data: "createTime"},
                    {
                    	...
                    	function(data, type, full) {   
                    		...
                    		var delNode = '<a href="${context}/admin/comment?method=del&id='+data+'"><button class="btn btn-primary btn-sm">删除</button></a>'
