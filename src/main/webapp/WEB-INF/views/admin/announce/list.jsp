                        ...
                        <div class="modal-content animated bounceInRight">
                           ...
                           <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form-horizontal" role="form" id="modalForm" method="post" action="${context }/admin/announce">
...
<div id="wrapper">    
	...
	<c:if test="${not empty sessionScope.session_user }">
		<%@ include file="/Public/include/back/announce/listPage.jsp" %>
	</c:if>
    ...
    var admin_table =  $("#admin_table").DataTable({
		  ...
		  */
          ...
          //"serverSide": true,  //服务端#分页 
           ajax: {
        	     //Ajax数据库请求
                 url: '${context}/admin/announce?method=ajaxquery',
          ...
          "columns": [
                    ...
                    { data: "createTime"},
                    {
                    	...
                    	function(data, type, full) {   
                    		...
                    		var delNode = '<a href="${context}/admin/announce?method=del&id='+data+'"><button class="btn btn-primary btn-sm">删除</button></a>'
