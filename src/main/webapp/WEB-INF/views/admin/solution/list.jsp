                        ...
                        <div class="modal-content animated bounceInRight">
                           ...
                           <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form-horizontal" role="form" id="modalForm" method="post" action="${context }/admin/solution">
...
<div id="wrapper">    
	...
	<c:if test="${not empty sessionScope.session_user }">
		<%@ include file="/Public/include/back/solution/listPage.jsp" %>
	</c:if>
 ...
 $(function(){
    ...
    var admin_table =  $("#admin_table").DataTable({
          ...
          //"serverSide": true,  //服务端#分页 
           ajax: {
        	     //Ajax数据库请求
                 url: '${context}/admin/solution?method=ajaxquery',
          ...
          "columns": [
                    ...
                    { data: "createTime"},
                    {
                    	...
                    	function(data, type, full) {   
                    		...
                    		var delNode = '<a href="${context}/admin/solution?method=del&id='+data+'"><button class="btn btn-primary btn-sm">删除</button></a>'
